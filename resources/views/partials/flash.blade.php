...
@if ($errors) @foreach($errors as $key => $value)
    <div class="alert alert-danger alert-dismissible" role="alert">
        ...
        <strong>{{trans('common.error')}}</strong> {{ $value }}
    </div>
@endforeach @endif
...
@if ($messages) @foreach($messages as $key => $value)
    <div class="alert alert-success alert-dismissible" role="alert">
        <button class="close" type="button" data-dismiss="alert">×</button>
        <strong>{{trans('common.success')}}</strong> {{ $value }}
    </div>
@endforeach @endif
...
@if ($info) @foreach($info as $key => $value)
    <div class="alert alert-info alert-dismissible" role="alert">
        <button class="close" type="button" data-dismiss="alert">×</button>
        <strong>{{trans('common.info')}}</strong> {{ $value }}
    </div>
@endforeach @endif
...
@if ($warnings) @foreach($warnings as $key => $value)
    <div class="alert alert-warning alert-dismissible" role="alert">
        <button class="close" type="button" data-dismiss="alert">×</button>
        <strong>{{trans('common.warning')}}</strong> {{ $value }}
    </div>
@endforeach @endif
