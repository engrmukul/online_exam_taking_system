...
class Bengali
{
    ...
    // Method - English to Bengali Month
    public static function bn_month($months)
    {
        return str_replace(self::$en_months, self::$bn_months, ucfirst($months));
    }
...
if (! function_exists('bnDate')) {
    function bnDate($date = ''){
        $obj = new Bengali();
        return $obj->bn_date($date);
    }
}

// BANGLE MONTH
if (! function_exists('bnMonth')) {
    function bnMonth($month = ''){
        $obj = new Bengali();
        return $obj->bn_month($month);
    }
}
...
if (! function_exists('bnNumber')) {
    function bnNumber($number = ''){
        $obj = new Bengali();
        return $obj->bn_number($number);
    }
}

if (! function_exists('numberFormatWithCurrency')) {
    function numberFormatWithCurrency($number = ''){
        $obj = new Bengali();
        return config('services.default_currency').' '.$obj->bn_number($number);
    }
}
